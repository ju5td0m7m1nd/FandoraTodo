...
/***/ function(module, exports, __webpack_require__) {
	...
	var _input_dev = __webpack_require__(160);

	var _input_dev2 = _interopRequireDefault(_input_dev);

	var _todoblock = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _filterbtn = __webpack_require__(162);
	...
	var TodoInput = _react2.default.createClass({
	    ...
	    getUserInput: function getUserInput() {
	        ...
	        var taskPair = { task: this.state.value, checked: false };
	    ...
	    updateChecked: function updateChecked(task) {
	        var newTodoList = this.state.todolist;
	        newTodoList[task]['checked'] = !newTodoList[task]['checked'];

	        // Update in local
	        var taskPair = newTodoList[task];
	        localForage.setItem(task, taskPair);

	        this.setState({ todolist: newTodoList });
	    },
	    handleFilterOn: function handleFilterOn() {
	        this.setState({ filter: false });
	    },
	    handleFilterOff: function handleFilterOff() {
	    ...
	    render: function render() {
	        ...
	        for (var i in this.state.todolist) {
	            if (this.state.filter || this.state.todolist[i]['checked']) {
	                block.push(_react2.default.createElement(_todoblock2.default, { taskid: i,
	        ...
	        return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement('input', { type: 'text', style: styles.input, onKeyDown: this.handleKeyDown, value: this.state.value, onChange: this.handleChange }),
	            _react2.default.createElement(_filterbtn2.default, { text: '已完成', handleFilterOn: this.handleFilterOn }),
	            _react2.default.createElement(_filterbtn2.default, { text: '全部', handleFilterOn: this.handleFilterOff }),
	            block
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoBlock = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var blockStyle = this.state.checked ? Object.assign({}, styles.todoblock, styles.checked) : Object.assign({}, styles.todoblock, {});
	        return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(
	                'div',
	                { className: 'todoblock', style: blockStyle },
	                _react2.default.createElement('input', { type: 'checkbox', defaultChecked: this.props.todotask['checked'] ? 'checked' : '', onChange: this.handleCheck }),
	                this.props.todotask['task']
	            ),
	            _react2.default.createElement(
	                'label',
	                { style: styles.cancel },
	                _react2.default.createElement('input', { type: 'checkbox', onChange: this.handleDelete }),
	                '刪除'
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FilterButton = _react2.default.createClass({
	    ...
	    render: function render() {
	        var filterStyle = this.state.hover ? Object.assign({}, styles.filterAfter, styles.filterAfterHover) : Object.assign({}, styles.filterAfter, {});
	        return _react2.default.createElement(
	            'div',
	            { onClick: this.props.handleFilterOn,
	                style: styles.filterBtn,
	                onMouseOver: this.handleMouseOver,
	                onMouseOut: this.handleMouseOut
	            },
	            this.props.text,
	            _react2.default.createElement('div', { style: filterStyle })
	        );
	    }
	});
